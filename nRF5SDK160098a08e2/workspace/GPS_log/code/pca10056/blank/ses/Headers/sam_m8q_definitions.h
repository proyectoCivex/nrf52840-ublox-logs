#ifndef _SAM_M8Q_DEFINITIONS_H
#define _SAM_M8Q_DEFINITIONS_H

#include "CommonHeaders.h"

//Default 7-bit unshifted address 
const uint8_t GPS_ADDRESS = 0x42; 


/*************************INIT OF UBX PROTOCOL CONSTANTS*************************/
...
// UBX Class 
// Descriptions taken from Interface Description page 146
...
//UBX IDs messages - Descriptions taken from Interface Description page 147-152

//The following are used for UBX Class ACK messages (Ack/Nak messges= 
const uint8_t UBX_ACK_NAK = 0x00;        //Message acknowledged
const uint8_t UBX_ACK_ACK = 0x01;         //Message not acknowledge

//The following are used for UBX Class CFG (Configuration Input Messages)
...
//The following are used to configure the RXM UBX messages (receiver manager messages)
...
//The following are used to configure the SEC UBX messages (security feature messages)
const uint8_t UBX_SEC_UNIQID = 0x03; //Unique chip ID

//The following are used to configure the TIM UBX messages (timing messages)
...
//The following are used to configure the UPD UBX messages (firmware update messages).
...
/*************************END OF UBX PROTOCOL CONSTANTS*************************/





/*************************INIT OF CONSTANTS USED FOR UBX-CFG MESSAGES*************************/
const uint8_t COM_BITFIELD_FLAGS = (1<<1);    //Bitfield flag to define extended timeout on the wait from the slave

//UBX-CFG-PRT message: The following consts are used to configure the various ports and streams for those ports
...
const uint8_t GNSSID_GPS=0;
const uint8_t GNSSID_SBAS=1;
const uint8_t GNSSID_GALILEO=2;
const uint8_t GNSSID_BEIDOU=3;
const uint8_t GNSSID_IMES=4;
const uint8_t GNSSID_QZSS=5;
const uint8_t GNSSID_GLONASS=6;

//UBX-CFG-VALSET message: These are the Bitfield layers definitions (not to be confused with Bitfield deviceMask in UBX-CFG-CFG)
const uint8_t VAL_LAYER_RAM = (1 << 0);
const uint8_t VAL_LAYER_BBR = (1 << 1);
const uint8_t VAL_LAYER_FLASH = (1 << 2);


//UBX-CFG-CFG message: Configuration Sub-Section mask definitions for saveConfigSelective 
...
/*************************END OF CONSTANTS USED FOR UBX-CFG MESSAGES*************************/



/*************************INIT OF NMEA PROTOCOL CONSTANTS*************************/
//The following are used to enable NMEA messages.  Descriptions taken from Interface Description page 118 
...
/*************************END OF NMEA PROTOCOL CONSTANTS*************************/




/*************************INIT OF RTCM PROTOCOL CONSTANTS*************************/
//The following are used to enable RTCM messages Descriptions taken from Interface Description page 33
...
/*************************END OF RTCM PROTOCOL CONSTANTS*************************/
